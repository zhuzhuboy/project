      ...
      >
        <el-row>
          ...
          <el-form-item label="设备类型" prop="type">
            <el-select v-model="listQuery.type" placeholder="请选择设备类型" clearable style="width:120px">
          ...
          <el-form-item label="代理地区" prop="agent_area">
            <el-input
              v-model="listQuery.agent_area"
              placeholder="请输入代理地区"
              clearable
              style="width:140px"
            />
