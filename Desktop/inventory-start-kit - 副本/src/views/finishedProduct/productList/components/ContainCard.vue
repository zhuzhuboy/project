  ...
  <el-card style="width: 80%">
    ...
    >
      ...
      <el-table-column label="用户ID" align="center" prop="agent_uid" width="100" />
       <el-table-column label="代理地区" align="center" prop="full_area" width="100" />
      ...
      <el-table-column label="设备机型" prop="is_special" width="120" align="center">
        <template v-slot="{row}">
      ...
      <el-table-column label="主机流水号" prop="hosts_number" width="140" align="center" />
