<template>
  <el-table border stripe :data="mateTableData" size="mini" highlight-current-row>
    ...
    <el-table-column align="center" label="物料编码" prop="r_goods_code" width="100" />
    ...
    <el-table-column align="center" label="退货数量" prop="ret_num" width="80" />
    ...
    <el-table-column align="center" label="税率" prop="tax_rate" width="80">
      <template v-slot="{row}">{{row.tax_rate.replace(/\.\d+/,'%')}}</template>
    </el-table-column>

    <el-table-column align="center" label="税金" prop="taxes" width="80" />

    <el-table-column align="center" label="含税价" prop="tax_price" width="80" />
