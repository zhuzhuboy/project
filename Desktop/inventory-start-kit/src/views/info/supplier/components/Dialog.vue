  ...
  <el-dialog :title="title" :visible.sync="dialogShow" width="30%" @close="cancelBtn('editForm')">
    <el-form ref="refForm" :model="data" label-width="80px">
      <el-form-item label="编号" prop="num">
        <el-input v-model="data.num" clearable placeholder="请输入供应商编号"></el-input>
      </el-form-item>
      <el-form-item label="名称" prop="supply_name">
        <el-input v-model="data.supply_name" clearable placeholder="请输入供应商名称"></el-input>
      </el-form-item>
      <el-form-item label="地址" prop="address">
        <el-input v-model="data.address" clearable placeholder="请输入供应商地址"></el-input>
      </el-form-item>
      <slot />
    </el-form>
